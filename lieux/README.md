...
|---|---|---|
| `lieux_lecture_france.csv` | Tout, schéma unifié (à importer) | 5 751 |
| `lieux_lecture_france.geojson` | Points géolocalisés, prêts pour Leaflet/MapLibre | 5 711 |
...
`period` · `precision` · `source` · `source_ref` · `last_updated`

- `type` : `librairie` | `festival` | `cafe_philo` | `cercle_lecture` → une icône par valeur.
